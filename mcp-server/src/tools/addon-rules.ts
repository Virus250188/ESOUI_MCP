...
const definitions = [
  {
    ...
    description:
      'Get official ESO addon development rules, restrictions, and best practices from ESOUI guidelines. Topics: restrictions (what addons MUST NOT do), best_practices, performance, localization, hooking, savedvariables, events, libraries, upload. Essential reference for addon development compliance.',
    inputSchema: {
      type: 'object' as const,
      properties: {
        topic: {
          type: 'string',
          enum: ['restrictions', 'best_practices', 'performance', 'localization', 'hooking', 'savedvariables', 'events', 'libraries', 'upload', 'all'],
